...
router.get('/', authorizeRoles('admin', 'teacher', 'student', 'coordinator'), subjectController.list);
router.get('/:id', authorizeRoles('admin', 'teacher', 'student', 'coordinator'), subjectController.getOne);
